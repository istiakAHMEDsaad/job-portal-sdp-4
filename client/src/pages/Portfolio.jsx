...
const Portfolio = () => {
  ...
  const { userData, portfolioData } = useContext(AppContext);
    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <div className='container mx-auto px-4 lg:px-16 mt-6'>
        ...
        <div className='flex items-center justify-between mb-6'>
          <h1 className='text-xl md:text-3xl font-bold'>Portfolio Overview</h1>
          ...
          <div className='flex gap-3'>
            <button
              ...
              className='bg-emerald-600 hover:bg-emerald-500 text-white cursor-pointer md:px-5 md:py-2 rounded-md transition max-sm:text-xs px-3 py-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400'
            >
              Download PDF
            </button>
            ...
            <button
              ...
              className={`bg-neutral-950 hover:bg-neutral-900 text-white md:px-5 md:py-2 rounded-md transition cursor-pointer max-sm:text-xs px-3 py-1`}
            >
              Edit Profile
            </button>
          </div>
        ...
        !skill ? (
          <p className='text-red-500'>
            Please update your info to download the resume
          </p>
        ) : (
          ''
        )}
